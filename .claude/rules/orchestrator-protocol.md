...
> **Routing:** Use this full loop for multi-file or cross-cutting changes. For single-file R/Julia/Stata/MATLAB script tasks, use `orchestrator-research.md` instead.
